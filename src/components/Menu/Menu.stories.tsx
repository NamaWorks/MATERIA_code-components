...
const mockLogo = (
  ...
  >
    <g clipPath="url(#story-m-clip)">
      ...
      <path
        d="M27.5 33.9998L27.6863 7.58984"
        stroke="white"
        strokeWidth="0.58"
        strokeMiterlimit="10"
      />
      <path
        d="M0.0898438 0.0898438H7.58674"
        stroke="white"
        strokeWidth="0.58"
        strokeMiterlimit="10"
      />
      <path
        d="M0.0898438 0.0439453V7.58741"
        stroke="white"
        strokeWidth="0.58"
        strokeMiterlimit="10"
      />
      <path
        d="M8.35124 18.9563H7.58105V7.50586H8.64006L12.8761 15.6057L13.8481 17.5358H13.9165L14.8916 15.6057L19.1432 7.50586H20.1835V18.9563H19.4165V10.1385L19.432 8.66831H19.3637L18.6307 10.1385L14.345 18.2725H13.4227L9.13696 10.1385L8.40093 8.66831H8.33261L8.35124 10.1385V18.9563Z"
        fill="white"
      />
    </g>
    <defs>
...
const mockNavLinks = (
  <>
    <a href="#nosotros" className={navLinkStyle}>
      NOSOTROS
    </a>
    <a href="#proyectos" className={navLinkStyle} {...{ 'dropdown-data': 'projects' }}>
      PROYECTOS
    </a>
    <a href="#productos" className={navLinkStyle} {...{ 'dropdown-data': 'products' }}>
      PRODUCTOS
    </a>
    <a href="#profesionales" className={navLinkStyle}>
      PROFESIONALES
    </a>
    <a href="#stock" className={navLinkStyle}>
      STOCK
    </a>
    <a href="#contacto" className={navLinkStyle}>
      W&nbsp;&nbsp;CONTACTO
    </a>
  </>
);
...
const mockProductosContent = (
  <div className="grid grid-cols-4 gap-[30px]">
    ...
    <ProductosItem
      title="Cocinas"
      items={['Mobiliario', 'Equipamiento interior', 'Encimeras y fregaderos', 'Electrodomésticos']}
    />
    <ProductosItem
      title="Baños"
      items={[
    ...
    />
    <ProductosItem
      title="Vestidores y armarios"
      items={['Vestidores', 'Armarios', 'Elementos singulares']}
    />
    <ProductosItem title="Puertas" items={['Correderas', 'Pivotantes', 'Vatientes', 'Plegables']} />
    <ProductosItem
      title="Pavimentos"
      items={['Porcelanicos', 'Piedras naturales', 'Madera', 'Cementino', 'Vinílicos y fibra']}
    />
    <ProductosItem title="Iluminación" items={['Técnica', 'Decorativa', 'Aspecto natural']} />
    <ProductosItem
      title="Complementos"
      items={['Cortinas y estores', 'Alfombras', 'Espejos', 'Piezas singulares']}
    />
  </div>
);
